...
public class LearningController {
    ...
    public ResponseEntity<QuizSubmissionResponseDTO> submitQuiz(
        ...
        Long usedUserId = userId != null ? userId : 1L; // fallback for tests
        log.info("=== QUIZ SUBMISSION ===");
        log.info("User ID: {}", usedUserId);
        ...
        QuizSubmissionResponseDTO response = learningService.submitQuizResults(usedUserId, results);
